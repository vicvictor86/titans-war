...
public class UIManager : MonoBehaviourPun
{
    ...
    {
        chooseExtraPowerCardPanel = GameManager.instance.MyChooseExtraPowerCardPanel;
        ...
        var displayPowerCounter = chooseExtraPowerCardPanel.GetComponent<DisplayPowerCounter>();
